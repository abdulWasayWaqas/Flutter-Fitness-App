// ignore_for_file: non_constant_identifier_names, prefer_const_constructors, constant_identifier_names, use_key_in_widget_constructors, avoid_print
...
class WeatherscreenState extends State<Weatherscreen> {
  ...
  Future<void> _getWeatherData() async {
    try {
      Weather? weatherData = await _wf.currentWeatherByLocation(
